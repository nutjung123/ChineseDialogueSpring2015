...
<<<<<<< HEAD
	class SpeakTransform
	{
		...
		public SpeakTransform(List<Feature> history_in, Feature previous_topic_in, AnalogyBuilder analogy_builder)
		{
			this.analogy_builder = analogy_builder;
		...
		public String TransformSpeak(Feature feat, string speak)
		{
			...
			if (analogy.Equals(""))
				...
				transformed_speak = speak + analogy;
