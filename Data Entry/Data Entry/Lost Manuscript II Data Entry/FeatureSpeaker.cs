...
namespace Dialogue_Data_Entry
{
    class FeatureSpeaker
    {
        ...
        private string[] spatialKey = new string[2] { "occurred in", "was the location of" };
        ...
        private string[] hierarchyKey = new string[6] {"happened with a", "was the location of", "occurred after", "occurred in", "occurred before"
                                                        , "was an action in"};
